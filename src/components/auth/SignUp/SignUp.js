...
const SignUp = (props) => {
  ...
  const registerUser = e => {
    ...
    if(password === confirmPassword) {
      ...
      document.getElementById("error").innerHTML = "Your password didn't matched...Please try again."
    }
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-4 col-md-offset-3 m-auto">
          ...
          <div className="sign-up-aria-logo py-4 m-auto">
            <img className="w-50 d-block m-auto" src="https://i.ibb.co/71T806h/logo-header.png" alt=""/>
          </div>
          <p id="error"></p>
